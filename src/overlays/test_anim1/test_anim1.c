...
void omInitObjMan(s32, s32);                                  /* extern */
...
void omSetStatBit(omObjData*, s32);                      /* extern */
...
void func_801059A0_3D3C80(void)
{
    ...
    omAddObj(0x2710, 0, 0, -1, &func_80106DF8_3D50D8);
    ...
    omAddObj(0x7D0, 0xA, 0xA, -1, &func_80105B38_3D3E18);
    omAddObj(0x7D0, 0, 0, -1, &func_80106898_3D4B78);
    HuWipeFadeIn(0, 0x10);
